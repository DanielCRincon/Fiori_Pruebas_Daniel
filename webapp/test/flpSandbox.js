		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#serviciossapinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"serviciossapinvoices-display": {
								"semanticObject": "serviciossapinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=serviciossap.invoices",
									"url": sap.ui.require.toUrl("serviciossap/invoices")
								}
							}
						}
					}
